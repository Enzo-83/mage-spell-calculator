...
function calculateSpellFactors(params) {
    ...
    const advancedPotencyReach = useAdvancedPotency ? 1 : 0;
    
    const totalReachUsed = 
        primaryFactorChangeReach +      // Changing primary factor
        advancedPotencyReach +          // Advanced potency
    ...
    return {
        ...
        reach: {
            ...
            breakdown: {
                ...
                advancedPotency: advancedPotencyReach,
        ...
        advancedPotency: useAdvancedPotency,
        spellControl: {
